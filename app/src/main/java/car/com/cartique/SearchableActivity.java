        ...
        databaseReference.child("Clients").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (Client client :   clients.values()) {
                    ...
                    item.setWebsite(client.getWebsite());
                    item.setCellNumber(client.getCellNumber());
                    item.setRepairType(client.getRepairType());
                    item.setServiceType(client.getServiceType());
                    item.setPaintType(client.getPaintType());
                    item.setGuarantee(client.getGuarantee());
                    item.setGroup(client.getGroup());
                    clientList.add(item);
                }
