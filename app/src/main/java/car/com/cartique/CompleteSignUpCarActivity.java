...
public class CompleteSignUpCarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtRegNo = findViewById(R.id.txtRegistrationCarPlate);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(txtMake.getText().toString())) {
                ...
                }else if (TextUtils.isEmpty(txtRegNo.getText().toString())) {
                    txtRegNo.setError(getString(R.string.service_regNo_error));
                } else{
                    ...
                    car.setRegNo(txtRegNo.getText().toString());
                    user.setCar(car);
                    ...
                    mDatabase.child(userId).setValue(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            mDatabase.child(userId).child("NotificationID").setValue(FirebaseInstanceId.getInstance().getToken()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
