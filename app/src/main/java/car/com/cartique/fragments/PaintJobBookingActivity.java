...
import car.com.cartique.LoginActivity;
        ...
        if (make.isEmpty() ) {
            ...
            mDatabase.child(userId).setValue(order).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    String message = notificationGenerator.getFCMTopicNotificationMessage("Cartique","New paint job booked by "+order.getUserName());
                    notificationGenerator.sendMessageToFcm(message,"AIzaSyAuLNHRXzUGzd3KLzYIjcfP1zOhRMcF88s");
