...
public class ServiceBookingActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String location = pref.getString(Config.LOCATION_STRING,"Default");
        if(location.equalsIgnoreCase("Default") || location.equalsIgnoreCase("All")|| location.isEmpty()){
            databaseReference.child("Clients").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (Client client : clients.values()) {
                        ...
                        item.setNotificationID(client.getNotificationID());
                        clientList.add(item);
                    }
            ...
            databaseReference.child("Clients").orderByChild("city").equalTo(location).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    GenericTypeIndicator<Map<String, Client>> genericTypeIndicator = new GenericTypeIndicator<Map<String, Client>>() {
                    };
