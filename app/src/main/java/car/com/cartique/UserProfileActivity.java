    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegisterNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userObj = preferences.getString(Config.USER_OBJECT,"");
                Gson gson = new Gson();
                User user = gson.fromJson(userObj,User.class);
                databaseReference.child("Clients").child(user.getUniqueID()).child("NotificationID").setValue(token).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
